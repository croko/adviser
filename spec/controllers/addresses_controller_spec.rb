  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved address as @address" do
        ...
        post :create, {:address => { "phone_number" => "invalid value" }}, valid_session
        assigns(:address).should be_a_new(Address)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested address" do
        ...
        Address.any_instance.should_receive(:update).with({ "phone_number" => "MyString" })
        put :update, {:id => address.to_param, :address => { "phone_number" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the address as @address" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Address.any_instance.stub(:save).and_return(false)
        put :update, {:id => address.to_param, :address => { "phone_number" => "invalid value" }}, valid_session
        assigns(:address).should eq(address)
      end
