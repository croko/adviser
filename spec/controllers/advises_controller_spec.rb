...
describe AdvisesController do
  ...
  describe "GET show" do
    it "assigns the requested registration as @registration" do
      ...
      assigns(:advise).should eq(registration)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved registration as @registration" do
        ...
        post :create, {:advise => { "user_id" => "invalid value" }}, valid_session
        assigns(:advise).should be_a_new(Advise)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested registration" do
        ...
        Advise.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => registration.to_param, :advise => { "user_id" => "1" }}, valid_session
      end

      it "assigns the requested registration as @registration" do
        registration = Advise.create! valid_attributes
        put :update, {:id => registration.to_param, :advise => valid_attributes}, valid_session
        assigns(:advise).should eq(registration)
      end
    ...
    describe "with invalid params" do
      it "assigns the registration as @registration" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Advise.any_instance.stub(:save).and_return(false)
        put :update, {:id => registration.to_param, :advise => { "user_id" => "invalid value" }}, valid_session
        assigns(:advise).should eq(registration)
      end
