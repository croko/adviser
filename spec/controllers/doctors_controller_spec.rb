  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved doctor as @doctor" do
        ...
        post :create, {:doctor => {  }}, valid_session
        assigns(:doctor).should be_a_new(Doctor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested doctor" do
        ...
        Doctor.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => doctor.to_param, :doctor => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the doctor as @doctor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Doctor.any_instance.stub(:save).and_return(false)
        put :update, {:id => doctor.to_param, :doctor => {  }}, valid_session
        assigns(:doctor).should eq(doctor)
      end
