  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_user" do
        ...
        AdminUser.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => admin_user.to_param, :admin_user => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_user as @admin_user" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        AdminUser.any_instance.stub(:save).and_return(false)
        put :update, {:id => admin_user.to_param, :admin_user => {  }}, valid_session
        assigns(:admin_user).should eq(admin_user)
      end
